...
import com.credera.bootcamp.module5.service.RepoBasedPracticeService;

@RunWith(SpringRunner.class)
@SpringBootTest
@ActiveProfiles("test")
public class TestRepoBasedPracticeService implements CommonPracticeTests {

    @Autowired
    protected RepoBasedPracticeService service;
